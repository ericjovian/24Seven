...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body >
        ...
        <div class="m-0 view" style="height:49vw">
            <div class="container-padding">
                <nav class="navbar navbar-expand-lg navbar-light ">
                        <p style="font-size:2.5vw;font-family:montserrat-bold;letter-spacing:0.5vw">24Seven</p>
                        <div class="collapse navbar-collapse" id="navbarText">
                            <div class="hidden fixed tot-position px-6 py-4 sm:block">
                                <!-- <a href="" >tot</a> -->

                            </div>
                            @if (Route::has('login'))
                                <div class="hidden fixed login-position px-6 py-4 sm:block">
                                    @auth
                                        <a href="{{ url('/dashboard') }}" class="text-sm text-gray-700 underline">Dashboard</a>
                                    @else
                                        <a href="{{ route('login') }}" class="text-sm text-gray-700 underline" style="font-family:montserrat-regular">Login</a>
                                    @endauth
                                </div>
                            @endif
